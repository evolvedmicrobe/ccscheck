...
namespace EmbeddedCCSCheck
{
    ...
    {
        static readonly string header = "Movie,ZMW,Ref,Pos,Length,Type,AtEnd,RefBP,AltBP,IndelType,InHP,Bases,HPLen,HPChar,llseq,llmut";

        public static string GetHeader() {
            return header;
        }

        public static void OutputVariants(Variant v, string movieName, string holeNumber, double[] LL, double[] mutLL, StreamWriter sw) {
